...
// ===== IC PAGE ANIMATIONS =====
const icFades = document.querySelectorAll('.ic-fade');
...
icFades.forEach(el => observer.observe(el));


// ===== FORM HANDLER =====
const form = document.getElementById("icContactForm");
...
if (form) {
  form.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        statusBox.innerHTML = "✅ Message sent!";
